...
public class CustomerMenu {
    ...
    public static List<String> CustomerMenu(int levelID) {
        ...
        if (levelID >= 1) folders.add("/images/gamePlay/ingredients/drinks/cola.png");
        if (levelID >= 2) folders.add("/images/gamePlay/ingredients/drinks/sprite.png");
        if (levelID >= 3) folders.add("/images/gamePlay/ingredients/drinks/orange.png");
