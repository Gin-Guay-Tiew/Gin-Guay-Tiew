...
public class LevelFactory {
    ...
    public static LevelUIConfig getLevel(int levelId, PlayerData data) {
        ...
        String bucketImg = "resources/images/gamePlay/ingredients/drinks/bucket.png"; // Fallback empty bucket
        ...
        switch (levelId) {
            case 1:
                ...
                // drink can change
                if (data.isItemUnlocked("Cola")) {
                    slots.add(new SlotSpec("cola",238,355,40,120,null,"SPAWN","resources/images/gamePlay/ingredients/drinks/cola/cola.png"));
                }

                // mock up dynamic bucket
                ...
                // row1
                if (data.isItemUnlocked("Rice vermicelli noodles")) {
                ...
                if (data.isItemUnlocked("Wide rice noodles")) {
                ...
                //row2
                if (data.isItemUnlocked("Yellow egg noodles")) {
                ...
                if (data.isItemUnlocked("Thin rice noodles")) {
            ...
            case 2:
                ...
                if (data.isItemUnlocked("Sprite")) {
                    slots.add(new SlotSpec("sprite", 267, 355, 40, 120, null, "SPAWN", "resources/images/gamePlay/ingredients/drinks/sprite/sprite.png"));
                }
            ...
            case 3:
                ...
                if (data.isItemUnlocked("Orange")) {
                    slots.add(new SlotSpec("orange", 301, 355, 40, 120, null, "SPAWN", "resources/images/gamePlay/ingredients/drinks/orange/orange.png"));
                }
            ...
            case 4:
                ...
                if (data.isItemUnlocked("Green egg noodles")) {
